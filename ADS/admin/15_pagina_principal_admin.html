        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="17_consultar_materias-php"><i class="fa fa-table"></i> MATERIAS</a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-table"></i> GRUPOS</a>
                    </li>	 
                     <li>
                        <a href="#"><i class="fa fa-edit"></i> USUARIOS<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="22_registrar_docentes_grupos.php">DOCENTES</a>
                            </li>
                            </ul>
                        </li>	
        		...
        		<li>
                    ...
                    <li>
                        <a href="empty.html"><i class="fa fa-fw fa-file"></i> CERRAR SESION</a>
                    </li>
                </ul>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div>
                                <ul>
                                    <li><a href="#">Registrar usuarios</a></li><br>
                                    <li><a href="#">Registrar alumnos a materias y grupos</a></li><br>
                                    <li><a href="#">Registrar docentes a materias y grupos</a></li><br>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div>
                                <ul>
                                    <li><a href="#">Relacionar padres</a></li><br>
                                    <li><a href="#">Administrar materias</a></li><br>
                                </ul>
                            </div>
                        </div>
                    </div>
