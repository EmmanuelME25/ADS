        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-desktop"></i>Materias</a>
                    </li> 
					 <li>
                        <a href="#"><i class="fa fa-sitemap"></i> Grupos</a>
						</li>	
                    <li>
                        <a href="#"><i class="fa fa-qrcode"></i> Usuarios</a>
                    </li>
                    
                    <li>
                        <a href="#"><i class="fa fa-table"></i> Cerrar seción</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
		    <div class="header"> 
                        <h1 class="page-header">
                            Materias <small>Consultar materias</small>
                        </h1>
						<ol class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div align="right">
                                    <td class="right"><a href="#" class="btn btn-success">Agregar</a></td>
                                    <td class="right" ><a href="#" class="btn btn-warning">Actualizar</a></td>
                                    <td class="right"><a href="#" class="btn btn-danger">Eliminar</a></td>
                                </div>
                            </div>
