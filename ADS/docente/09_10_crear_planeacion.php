...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
            <h1 class="page-header">Planeación</h1>
            <ol class="breadcrumb">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="nombre_act">Nombre de Actividad:</label>
                                    <input type="text" class="form-control" id="nombre_act" placeholder="Ingresar nombre de actividad">
                                </div>
                                <div class="form-group">
                                    <label for="objetivo">Objetivo:</label>
                                    <input type="text" class="form-control" id="objetivo" placeholder="Ingresar objetivo de actividad">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha" placeholder="Ingresar fecha planeada para la actividad">
                                </div>
                                <div class="form-group">
                                    <label for="material_adj">Materiales adjuntos:</label>
                                    <input type="file" class="form-control" id="material_adj">
                                </div>
                                <div class="form-group">
                                    <label for="material_ini">Materiales iniciales:</label>
                                    <div>
                                        <textarea class="form-control" rows="3" id="material_ini"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="material_adi">Materiales adicionales:</label>
                                    <div>
                                        <textarea class="form-control" rows="3" id="material_adi"></textarea>
                                    </div>
                                </div>
