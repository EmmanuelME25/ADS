        ...
        <div id="page-wrapper" >
		  <div class="header"> 
            <h1 class="page-header">
                Califcaciones parciales<small>Actualizar calificaciones parciales</small> </h1>
            <ol class="breadcrumb">
                <li><a href="#">Página Principal</a></li>
                <li><a href="#">Calificaciones parciales</a></li>
                <li class="active">Actualizar calificaciones parciales</li>
            </ol> 		
		</div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>A</td>
                                                <td><input type="text" class="form-control" id="calif_par1" placeholder="9" ></td>
                                                <td><input type="text" class="form-control" id="calif_par2" placeholder="Calificar"></td>
                                                <td><input type="text" class="form-control" id="calif_par3" placeholder="Calificar" ></td>
                                                <td><input type="text" class="form-control" id="calif_F" placeholder="Calificar"></td>
                                            </tr>
                                            <tr>
