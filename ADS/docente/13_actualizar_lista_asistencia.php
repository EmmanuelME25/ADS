...
<head>
    ...
    <title>Actualizar Lista de Asistencia</title>
	<!-- Bootstrap Styles-->
        ...
        <div id="page-wrapper">
		    <div class="header"> 
                        <h1 class="page-header">
                            Pase de Lista <small>Generar lista de asistencia</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Inicio</a></li>
					  <li><a href="#">Pase de Lista</a></li>
					  <li class="active">Generar lista de asistencia</li>
					</ol> 
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-8">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="select" style="width:250px">
                                                        <option value="value1" selected>Presente</option>
                                                        <option value="value2">Ausente</option>
                                                        <option value="value3">Justificado</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <!--Panel de la derecha con los select-->
                    </div>
                </div>
