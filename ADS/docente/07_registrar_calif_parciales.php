...
<head>
    ...
    <title>Registrar calificaciones de parciales</title>
	<!-- Bootstrap Styles-->
        ...
        <div id="page-wrapper" >
            <div class="header"> 
                <h1 class="page-header">
                    Calificaciones parciales<small>Calificar parcial</small> </h1>
                <ol class="breadcrumb">
                    <li><a href="#">Página Principal</a></li>
                    <li><a href="#">Calificaciones parciales</a></li>
                    <li class="active">Calificar parcial</li>
                </ol> 		
            </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>A</td>
                                                <td><input type="text" class="form-control" id="calif_par" placeholder="9" disabled></td>
                                                <td><input type="text" class="form-control" id="calif_par" placeholder="Calificar"></td>
                                                <td><input type="text" class="form-control" id="calif_par" placeholder="Calificar" disabled></td>
                                                <td><input type="text" class="form-control" id="calif_par" placeholder="Calificar" disabled></td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="form-group" align="center">
                                    <br>
                                    <a href="08_actualizar_calif_parciales.html" class="btn btn-primary">Modificar parciales anteriores</a>
                                </div>
